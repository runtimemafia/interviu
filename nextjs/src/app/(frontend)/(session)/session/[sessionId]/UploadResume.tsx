...
const UploadResume = () => {
  ...
  const { setQuestions, questions, setResumeText, resumeText } =
    useQuestionStore();
  ...
  useEffect(() => {
    const formData = new FormData();
    formData.append("resumeData", resumeText as string);
    formData.append("additional_prompt", "");
    ...
    axios
      ...
      .then((res2) => {
        ...
        const questions = res2.data.map((q: {question: string, answer:string}) => {
          return {
            question: q.question,
            answer: q.answer,
            children: [],
  ...
  return (
    <>
      <div className="border p-4 rounded-md">
        ...
        <div className="px-8 py-5 border rounded-lg hover:border-primary-300 cursor-pointer relative mt-4">
          <input
            type="file"
            accept=".pdf"
